    ...
    <?php if(count($items) > 0){ ?>
      <table class="table table-bordered text-center">
        ...
        <tbody>
          ...
          <tr class="<?php print(h(is_open($item) ? '' : 'close_item')); ?>"><!-- エスケープ処理の実装 -->
            <td><img src="<?php print(h(IMAGE_PATH . $item['image']));?>" class="item_image"></td><!-- エスケープ処理の実装 -->
            <td><?php print(h($item['name'])); ?></td><!-- エスケープ処理の実装 -->
            <td><?php print(h(number_format($item['price']))); ?>円</td><!-- エスケープ処理の実装 -->
            <td>
