...
<head>
  ...
  <link rel="stylesheet" href="<?php print htmlspecialchars(STYLESHEET_PATH . 'admin.css'); ?>">
</head>
...
<body>
  ...
  <div class="container">
    ...
    <?php if (count($carts) > 0) { ?>
        ...
        <tbody>
          <?php foreach ($carts as $cart) { ?>
            <tr>
              ...
              <td>
                <?php print htmlspecialchars($cart['amount']); ?>個
              </td>
      ...
      <p class="text-right">合計金額: <?php print htmlspecialchars(number_format($total_price)); ?>円</p>
    <?php } else { ?>
      <p>カートに商品はありません。</p>
    <?php } ?>
  </div>
